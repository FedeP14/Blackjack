...
// makes cards in hands more distinguishable
...
func (h Hand) DealerSrting() string {
...
func main() {
	var gs GameState
	// cards is a deck of cards composed by 3 deck of cards
	gs = Shuffle(gs)
	gs = Deal(gs)
	...
	for gs.State == StatePlayerTurn {
		...
		fmt.Println("Dealer:", gs.Dealer.DealerSrting())
